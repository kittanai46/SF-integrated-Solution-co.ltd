...
class FormMapper {
  ...
  // PersonMigwis
  List<FormDetail> mapPersonMigwis(PersonMigwisDto? person){
    List<FormDetail> formArray = [];
    if(person!=null){
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_NUMBER, desc: person.alienNumber));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_GIVENNAME, desc: person.alienGivenname));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_MIDDLENAME, desc: person.alienMiddlename));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_SURNAME, desc: person.alienSurname));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_DOB, desc: person.alienDob));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_SEX, desc: person.alienSex));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_NATIONALITY, desc: person.alienNationality));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_DOC_NUMBER, desc: person.alienDocNumber));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_DOC_EXPIRYDATE, desc: person.alienDocExpirydate));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ALIEN_DOC_ISSUECTRY, desc: person.alienDocIssuectry));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_ENROLLMENT_REASON, desc: person.enrollmentReason));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_CONTACT, desc: person.contact));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_BORDERPOST, desc: person.borderpost));
      formArray.add(FormDetail(isHeader: false, title: PersonMigwisConstant.m_NOTE, desc: person.note));
    }
    return formArray;
  }
