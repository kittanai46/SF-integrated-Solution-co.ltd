...
class SearchCriteriaScreenViewModel = SearchCriteriaScreenViewModelBase
    with _$SearchCriteriaScreenViewModel;
...
abstract class SearchCriteriaScreenViewModelBase with Store {
      ...
      case AppConstant.kSearchPerson:
        {
          ...
          if (userDto != null &&
              userDto!.roleSearchExternal!.flagPersonDopaLinkage!) {
            scope.showInputPid = true;
            scope.showInputNames = true;
      ...
      case AppConstant.kSearchCar:
        {
          ...
          // ------------ OUTER --------------
          if (userDto != null &&
              userDto!.roleSearchExternal!.flagVerhicleDlt!) {
            scope.showInputPlateProv = true;
            scope.showInputNumBody = true;
          }
          if (userDto != null &&
              userDto!.roleSearchExternal!.flagVerhiclePtm!) {
      ...
      case AppConstant.kSearchInfo:
        {
          ...
          // ------------ INNER --------------
          if (userDto != null &&
              (userDto!.roleSearchInternal!.flagCrimecase! ||
      ...
      case AppConstant.kSearchPerson:
        {
          ...
          StringUtils.log("scope.hasInputAlienNo :" + scope.alienNo.toString());

          isEnableButton = scope.hasInputPid ||
              scope.hasInputPasId ||
              scope.hasInputNames ||
      ...
      case AppConstant.kSearchCar:
        {
          ...
          scope.hasInputPlateProv = scope.plate1Vh.isNotEmpty &&
              scope.plate2Vh.isNotEmpty &&
              scope.provcode.isNotEmpty &&
          ...
          scope.hasInputPlate = scope.plate1Vh.isNotEmpty &&
              scope.plate2Vh.isNotEmpty &&
              scope.provcode.isNotEmpty;
          scope.hasInputLicenseNumber = scope.licensenumber.isNotEmpty;

          isEnableButton = scope.hasInputFullNoPlate ||
              scope.hasInputFullEngineNo ||
  ...
  @observable
  ActionStatus screenStatus = ActionStatus.idle;
  @observable
  String errorTitle = '';
  @observable
  String? errorMessage = '';
