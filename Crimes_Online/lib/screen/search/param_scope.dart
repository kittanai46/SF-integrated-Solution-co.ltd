...
class ParamScope {
  ...
  // Common
  String pid =
      ''; //                              - cc_person                         - tc_person                  - warrant    - civil              - car   - social   - health                                 - gun   - traffic  - rescue
  String firstName =
      ''; //                              - cc_person                         - tc_person                  - warrant    - civil              - car                                     - foreign_house           - traffic  - rescue
  String lastName =
      ''; //                              - cc_person                         - tc_person                  - warrant    - civil              - car                                     - foreign_house           - traffic  - rescue

  // Crimecase, Trafficcase, Warrant
  String orgCode =
      ''; //  รหัสหน่วยงาน           - cc   - cc_person   - cc_vehicle   - tc   - tc_person   - tc_vehicle   - warrant
  String crimeCaseYear =
      ''; //  เลขท่ีปีคดี              - cc   - cc_person   - cc_vehicle   - tc   - tc_person   - tc_vehicle
  String crimeCaseNo =
      ''; //  เลขที่คดี               - cc   - cc_person   - cc_vehicle   - tc   - tc_person   - tc_vehicle
  String pasId =
      ''; //  เลขพาสปอร์ต - ผู้ต้องหา         - cc_person                         - tc_person
  String nation =
      ''; //  สัญชาติ - ผู้ต้องหา              - cc_person                         - tc_person
  String proviceTc =
      ''; //  จังหวัด - ทะเบียนรถ                          - cc_vehicle                        - tc_vehicle
  String intitialNo =
      ''; //  ตัวอักษร - ทะเบียนรถ                         - cc_vehicle                        - tc_vehicle
  String number =
      ''; //  ตัวเลข - ทะเบียนรถ                          - cc_vehicle                        - tc_vehicle
  String status =
      ''; //  สถานะยานพาหนะในคดี                         - cc_vehicle                        - tc_vehicle
  String engineNo =
      ''; //  เลขตัวเครื่อง                                - cc_vehicle                        - tc_vehicle
  String proviceWr =
      ''; //                                                                                               - warrant
  String tambonWr =
      ''; //                                                                                               - warrant
  ...
  // AlienNo
  String alienNo = ''; //  หมายเลขทะเบียนแรงงาน

  // Car
  String pltcode1 = ''; //  รหัสประเภทใบอนุญาตขับรถ
  String pltcode2 =
      ''; //  รหัสประเภทใบอนุญาตขับรถ-ขนส่ง  //                                                                                                - car
  String plate1Vh =
      ''; //  ทะเบียนรถ (ตัวอักษร)                                                                                                             - car                                                                           - rescue
  String plate2Vh =
      ''; //  ทะเบียนรถ (ตัวเลข)                                                                                                              - car                                                                           - rescue
  String provcode =
      ''; //  รหัสทะเบียนรถ (จังหวัด)                                                                                                           - car                                                                           - rescue
  String vhtype =
      ''; //  รหัสประเภทยานพาหนะ(กรมขนส่ง)                                                                                                    - car
  String numbody =
      ''; //  หมายเลขตัวถัง                                                                                                                   - car
  String brncode =
      ''; //  รหัสยี่ห้อ(กรมขนส่ง)                                                                                                               - car
  String licensenumber =
      ''; //  เลขหนังสืออนุญาต                                                                                                               - car

  // Social
  String accno =
      ''; //  รหัสสถานประกอบการ                                                                                                                      - social
  String accbranch =
      ''; //  รหัสสาขา                                                                                                                               - social

  // Immigration, ForeignHouse
  String passportNo =
      ''; //  เลขพาสปอร์ต                                                                                                                                              - immigration   - foreign_house
  String tmrunno =
      ''; //  หมายเลขอ้างอิง                                                                                                                                            - immigration

  // Traffic
  String plate1Tf =
      ''; //  ทะเบียนรถ (ตัวอักษร)                                                                                                                                                                                  - traffic
  String plate2Tf =
      ''; //  ทะเบียนรถ (ตัวเลข)                                                                                                                                                                                   - traffic
  String plate3Tf =
      ''; //  ทะเบียนรถ (จังหวัด)                                                                                                                                                                                   - traffic
  String ticketId =
      ''; //  เลขที่ใบสั่ง                                                                                                                                                                                           - traffic
      ...
      case AppConstant.kSearchPerson:
        {
          ...
          StringUtils.log(
              "flagPersonTm: $userDto.roleSearchExternal!.flagPersonTm");
          if (userDto.roleSearchExternal!.flagPersonTm!) {
            StringUtils.log("showInputAlienNo: $showInputAlienNo");

            showInputPid = true;
            showInputNames = true;
            showInputPassportNo = true;
            showInputAlienNo = true;
            StringUtils.log("showInputAlienNo: $showInputAlienNo");
          }
  ...
  void refreshHasInput(String type) {
    switch (type) {
      case AppConstant.kSearchPerson:
        {
          ...
          hasInputPidPlt1 =
              (pid.isNotEmpty && pid.length == 13) && pltcode1.isNotEmpty;
          hasInputNamesPlt1 = (firstName.isNotEmpty && lastName.isNotEmpty) &&
              pltcode1.isNotEmpty;
          hasInputPidPlt2 =
              (pid.isNotEmpty && pid.length == 13) && pltcode2.isNotEmpty;
          hasInputNamesPlt2 = (firstName.isNotEmpty && lastName.isNotEmpty) &&
              pltcode2.isNotEmpty;

          hasInputImg = base64Image != null;
          hasInputGunReg = gunReg.isNotEmpty;

          hasInputAlienNo = alienNo.isNotEmpty;
        }
        break;
      case AppConstant.kSearchCar:
        {
          hasInputFullNoPlate = proviceTc.isNotEmpty &&
              intitialNo.isNotEmpty &&
              number.isNotEmpty &&
              status.isNotEmpty;
          hasInputFullEngineNo = engineNo.isNotEmpty && status.isNotEmpty;
          hasInputPlateProv = plate1Vh.isNotEmpty &&
              plate2Vh.isNotEmpty &&
              provcode.isNotEmpty &&
              vhtype.isNotEmpty;
          hasInputNumBody = numbody.isNotEmpty && brncode.isNotEmpty;
          hasInputPlateTicket = (plate1Tf.isNotEmpty &&
                  plate2Tf.isNotEmpty &&
                  plate3Tf.isNotEmpty) ||
              ticketId.isNotEmpty;
          hasInputPlate =
              plate1Vh.isNotEmpty && plate2Vh.isNotEmpty && provcode.isNotEmpty;
        }
        break;
      case AppConstant.kSearchWeapon:
        {}
      ...
      case AppConstant.kSearchInfo:
        {
          hasInputFullcaseNo = orgCode.isNotEmpty &&
              crimeCaseYear.isNotEmpty &&
              crimeCaseNo.isNotEmpty;
        }
        break;
      case AppConstant.kSearchFirm:
        {}
