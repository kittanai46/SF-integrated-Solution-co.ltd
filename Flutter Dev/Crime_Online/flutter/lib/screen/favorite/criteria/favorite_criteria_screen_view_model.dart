...
class FavoriteCriteriaScreenViewModel = FavoriteCriteriaScreenViewModelBase with _$FavoriteCriteriaScreenViewModel;
...
abstract class FavoriteCriteriaScreenViewModelBase with Store {
  ...
  void _refreshEnableButton() {
    ...
    switch (searchType) {
      case AppConstant.kSearchPerson: {
        ...
        isEnableButton = favoriteDto.choices!=null && favoriteDto.choices!.length > 0 && (scope.hasInputPid || scope.hasInputPasId || scope.hasInputNames || scope.hasInputWorkerId || scope.hasInputPassportNo || scope.hasInputPidPlt1 || scope.hasInputNamesPlt1 || scope.hasInputPidPlt2 || scope.hasInputNamesPlt2  || scope.hasInputImg || scope.hasInputGunReg);
      ...
      case AppConstant.kSearchCar: {
        ...
        scope.hasInputPlateProv = scope.proviceTc.isNotEmpty && scope.intitialNo.isNotEmpty && scope.number.isNotEmpty && scope.vhtype.isNotEmpty;
        ...
        isEnableButton = favoriteDto.choices!=null && favoriteDto.choices!.length > 0 && (scope.hasInputFullNoPlate || scope.hasInputFullEngineNo || scope.hasInputPlateProv || scope.hasInputNumBody || scope.hasInputPlateTicket || scope.hasInputLicenseNumber);
      }
      break;
      ...
      case AppConstant.kSearchInfo: {
        ...
        isEnableButton = favoriteDto.choices!=null && favoriteDto.choices!.length > 0 && scope.hasInputFullcaseNo;
      }
      break;
  ...
  void _refreshEditFavorite() {
    ...
    for(int i=0; i<choices!.length; i++){
      ...
      switch(value){
        case AppConstant.showFormIdCard: scope.pid = mockValue; break;
        case AppConstant.showFormFirstName: scope.firstName = mockValue; break;
        case AppConstant.showFormLastName: scope.lastName = mockValue; break;
        case AppConstant.showFormWorkerId: scope.workerId = mockValue; break;
        case AppConstant.showFormPasId: scope.pasId = mockValue; break;
        case AppConstant.showFormNation: scope.nation = mockValue; break;
        case AppConstant.showFormGunReg: scope.gunReg = mockValue; break;
        case AppConstant.showFormProviceTc: scope.proviceTc = mockValue; break;
        case AppConstant.showFormIntitialNo: scope.intitialNo = mockValue; break;
        case AppConstant.showFormNumber: scope.number = mockValue; break;
        case AppConstant.showFormStatus: scope.status = mockValue; break;
        case AppConstant.showFormEngineNo: scope.engineNo = mockValue; break;
        case AppConstant.showFormPltcode1: scope.pltcode1 = mockValue; break;
        case AppConstant.showFormPltcode2: scope.pltcode2 = mockValue; break;
        case AppConstant.showFormPlate1Vh: scope.plate1Vh = mockValue; break;
        case AppConstant.showFormPlate2Vh: scope.plate2Vh = mockValue; break;
        case AppConstant.showFormProvcode: scope.provcode = mockValue; break;
        case AppConstant.showFormVhtype: scope.vhtype = mockValue; break;
        case AppConstant.showFormNumbody: scope.numbody = mockValue; break;
        case AppConstant.showFormBrncode: scope.brncode = mockValue; break;
        case AppConstant.showFormLicenseNumber: scope.licensenumber = mockValue; break;
        case AppConstant.showFormTicketId: scope.ticketId = mockValue; break;
        case AppConstant.showFormOrgCode: scope.orgCode = mockValue; break;
        case AppConstant.showFormCrimeCaseYear: scope.crimeCaseYear = mockValue; break;
        case AppConstant.showFormCrimeCaseNo: scope.crimeCaseNo = mockValue; break;
      }
    }
