...
part of 'scanqr_login_screen_view_model.dart';
...
mixin _$ScanQRLoginScreenViewModel on ScanQRLoginScreenViewModelBase, Store {
  late final _$barcodeAtom =
      Atom(name: 'ScanQRLoginScreenViewModelBase.barcode', context: context);
  ...
  late final _$successMessageAtom = Atom(
      name: 'ScanQRLoginScreenViewModelBase.successMessage', context: context);
  ...
  late final _$statusAtom =
      Atom(name: 'ScanQRLoginScreenViewModelBase.status', context: context);
  ...
  late final _$errorTitleAtom =
      Atom(name: 'ScanQRLoginScreenViewModelBase.errorTitle', context: context);
  ...
  late final _$errorMessageAtom = Atom(
      name: 'ScanQRLoginScreenViewModelBase.errorMessage', context: context);
  ...
  late final _$showErrorAtom =
      Atom(name: 'ScanQRLoginScreenViewModelBase.showError', context: context);
  ...
  late final _$requestLoginScanQRAsyncAction = AsyncAction(
      'ScanQRLoginScreenViewModelBase.requestLoginScanQR',
      context: context);
  ...
  late final _$requestLoginScanQRCRIMESAsyncAction = AsyncAction(
      'ScanQRLoginScreenViewModelBase.requestLoginScanQRCRIMES',
      context: context);
  ...
  late final _$ScanQRLoginScreenViewModelBaseActionController =
      ActionController(
          name: 'ScanQRLoginScreenViewModelBase', context: context);

  @override
  void resetStatus() {
    final _$actionInfo = _$ScanQRLoginScreenViewModelBaseActionController
        .startAction(name: 'ScanQRLoginScreenViewModelBase.resetStatus');
    try {
      return super.resetStatus();
    } finally {
      _$ScanQRLoginScreenViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
